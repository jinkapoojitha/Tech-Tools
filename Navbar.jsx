...
export default function NavbarHome() {
    ...
    return (
        <Navbar expand="lg" className='sticky-top bg-light' style={{ minHeight: '2cm',boxShadow: '0 0 4px 0.2px #333' }}>
            <Container fluid>
                <Link className='navbar-brand' to='/'>
                    <span id='logo' style={{ color: '#363636' }}>Tech-Tools</span>
                </Link>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title className='heading'>Select a Branch : </Modal.Title>
                </Modal.Header>
                <Modal.Body>
